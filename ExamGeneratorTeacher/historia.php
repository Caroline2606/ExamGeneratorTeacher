...
<body>
    ...
    <header id="header_przedmiot">ROZWIĄŻ ZADANIA Z HISTORII</header><br><br>

    <section id="odczyt_historia">
        <?php
            $baza=mysqli_connect("localhost", "root", "");
            mysqli_select_db($baza, "exam_generator");
            $zapytanie1="SELECT historia.Zadanie FROM historia";
    ...
    <section id="zapis_historia">
        <?php
            $Odpowiedz=$_POST['Odpowiedz'];
            $baza=mysqli_connect("localhost", "root", "");
            mysqli_select_db($baza, "exam_generator");

            $zapytanieOdp="INSERT INTO historia_student_odp VALUES('', '$Odpowiedz')";
